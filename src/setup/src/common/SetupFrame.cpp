       ...
       : wxFrame(NULL, -1, title, pos, size, style)
{
     ...
     *
     * - 10 Aug 2013 - I updated my wxFormBuild software, and now it's able to do
     *                 more of what I need. I've updated the setup project, and 
    ...
    this->SetFont( wxFont( 10, 74, 90, 90, false, wxT("Sans") ) );
    ...
    playersAndKeysLabel = new wxStaticText( masterPanel, wxID_ANY, wxT("Players and Keys:"), wxDefaultPosition, wxDefaultSize, 0 );
    playersAndKeysLabel->Wrap( -1 );
    playersAndKeysLabel->SetFont( wxFont( 10, 74, 90, 90, false, wxT("Sans") ) );
    ...
    p1Panel = new wxPanel( masterPanel, myID_P1_PANEL, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    ...
    p1Name->SetMaxLength( 0 ); 
    p1NameVBox->Add( p1Name, 0, wxBOTTOM|wxEXPAND|wxRIGHT|wxTOP, 5 );
    
    
    p1EnabledHBox->Add( p1NameVBox, 1, wxEXPAND, 5 );
    ...
    p1ControlsGrid->Add( 0, 0, 0, wxEXPAND, 5 );
    ...
    wxBoxSizer* p1PushBox;
    p1PushBox = new wxBoxSizer( wxVERTICAL );
    ...
    p1PushBox->Add( p1PushButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p1ControlsGrid->Add( p1PushBox, 1, wxEXPAND, 5 );
    
    wxBoxSizer* p1RightVBox;
    p1RightVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p1RightVBox->Add( p1RightButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p1ControlsGrid->Add( p1RightVBox, 1, wxEXPAND, 5 );
    
    
    p1ControlsGrid->Add( 0, 0, 1, wxEXPAND, 5 );
    
    wxBoxSizer* p1DownVBox;
    p1DownVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p1DownVBox->Add( p1DownButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p1ControlsGrid->Add( p1DownVBox, 1, wxEXPAND, 5 );
    ...
    p1BoxSizer->Add( p1VBox, 0, wxEXPAND, 5 );
    
    
    p1Panel->SetSizer( p1BoxSizer );
    p1Panel->Layout();
    p1BoxSizer->Fit( p1Panel );
    playersGridSizer->Add( p1Panel, 1, wxEXPAND | wxALL, 5 );
    
    p2Panel = new wxPanel( masterPanel, myID_P2_PANEL, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    ...
    p2Name->SetMaxLength( 0 ); 
    p2NameVBox->Add( p2Name, 0, wxBOTTOM|wxEXPAND|wxRIGHT|wxTOP, 5 );
    
    
    p2EnabledHBox->Add( p2NameVBox, 1, wxEXPAND, 5 );
    ...
    p2ControlsGrid->Add( 0, 0, 0, wxEXPAND, 5 );
    ...
    p2ControlsGrid->Add( p2UpVBox, 0, wxEXPAND, 5 );
    ...
    p2ControlsGrid->Add( p2LeftVBox, 0, wxEXPAND, 5 );
    
    wxBoxSizer* p2PushBox;
    p2PushBox = new wxBoxSizer( wxVERTICAL );
    ...
    p2PushBox->Add( p2PushButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p2ControlsGrid->Add( p2PushBox, 0, wxEXPAND, 5 );
    
    wxBoxSizer* p2RightVBox;
    p2RightVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p2RightVBox->Add( p2RightButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p2ControlsGrid->Add( p2RightVBox, 0, wxEXPAND, 5 );
    
    
    p2ControlsGrid->Add( 0, 0, 1, wxEXPAND, 5 );
    
    wxBoxSizer* p2DownVBox;
    p2DownVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p2DownVBox->Add( p2DownButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p2ControlsGrid->Add( p2DownVBox, 0, wxEXPAND, 5 );
    
    
    p2VBox->Add( p2ControlsGrid, 0, wxALL|wxEXPAND, 5 );
    ...
    p2BoxSizer->Add( p2VBox, 0, wxEXPAND, 5 );
    
    
    p2Panel->SetSizer( p2BoxSizer );
    p2Panel->Layout();
    p2BoxSizer->Fit( p2Panel );
    playersGridSizer->Add( p2Panel, 1, wxEXPAND | wxALL, 5 );
    
    p3Panel = new wxPanel( masterPanel, myID_P3_PANEL, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    ...
    p3Name->SetMaxLength( 0 ); 
    p3NameVBox->Add( p3Name, 0, wxBOTTOM|wxEXPAND|wxRIGHT|wxTOP, 5 );
    
    
    p3EnabledHBox->Add( p3NameVBox, 1, wxEXPAND, 5 );
    ...
    p3ControlsGrid->Add( p3UpVBox, 0, wxEXPAND, 5 );
    ...
    p3ControlsGrid->Add( p3LeftVBox, 0, wxEXPAND, 5 );
    
    wxBoxSizer* p3PushBox;
    p3PushBox = new wxBoxSizer( wxVERTICAL );
    ...
    p3PushBox->Add( p3PushButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p3ControlsGrid->Add( p3PushBox, 0, wxEXPAND, 5 );
    
    wxBoxSizer* p3RightVBox;
    p3RightVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p3RightVBox->Add( p3RightButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p3ControlsGrid->Add( p3RightVBox, 0, wxEXPAND, 5 );
    
    
    p3ControlsGrid->Add( 0, 0, 1, wxEXPAND, 5 );
    
    wxBoxSizer* p3DownVBox;
    p3DownVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p3DownVBox->Add( p3DownButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p3ControlsGrid->Add( p3DownVBox, 0, wxEXPAND, 5 );
    
    
    p3VBox->Add( p3ControlsGrid, 0, wxALL|wxEXPAND, 5 );
    ...
    p3BoxSizer->Add( p3VBox, 0, wxEXPAND, 5 );
    
    
    p3Panel->SetSizer( p3BoxSizer );
    p3Panel->Layout();
    p3BoxSizer->Fit( p3Panel );
    playersGridSizer->Add( p3Panel, 1, wxEXPAND | wxALL, 5 );
    
    p4Panel = new wxPanel( masterPanel, myID_P4_PANEL, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    ...
    p4ControlsGrid->Add( p4UpVBox, 0, wxEXPAND, 5 );
    ...
    p4ControlsGrid->Add( p4LeftVBox, 0, wxEXPAND, 5 );
    
    wxBoxSizer* p4PushBox;
    p4PushBox = new wxBoxSizer( wxVERTICAL );
    ...
    p4PushBox->Add( p4PushButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p4ControlsGrid->Add( p4PushBox, 0, wxEXPAND, 5 );
    
    wxBoxSizer* p4RightVBox;
    p4RightVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p4RightVBox->Add( p4RightButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p4ControlsGrid->Add( p4RightVBox, 0, wxEXPAND, 5 );
    
    
    p4ControlsGrid->Add( 0, 0, 1, wxEXPAND, 5 );
    
    wxBoxSizer* p4DownVBox;
    p4DownVBox = new wxBoxSizer( wxVERTICAL );
    ...
    p4DownVBox->Add( p4DownButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
    
    
    p4ControlsGrid->Add( p4DownVBox, 0, wxEXPAND, 5 );
    
    
    p4VBox->Add( p4ControlsGrid, 0, wxALL|wxEXPAND, 5 );
    ...
    p4BoxSizer->Add( p4VBox, 0, wxEXPAND, 5 );
    
    
    p4Panel->SetSizer( p4BoxSizer );
    p4Panel->Layout();
    p4BoxSizer->Fit( p4Panel );
    playersGridSizer->Add( p4Panel, 1, wxEXPAND | wxALL, 5 );
    
    
    masterVBoxSizer->Add( playersGridSizer, 1, wxEXPAND, 5 );
    ...
    soundCheckBox->SetFont( wxFont( 11, 74, 90, 90, false, wxT("Sans") ) );
    ...
    difficultySizer->Add( difficultyChoice, 0, wxALL|wxEXPAND, 5 );
    ...
    buttonAlignmentSizer->Add( buttonSizer, 1, wxEXPAND, 5 );
    ...
    masterPanelSizer->Add( masterPanel, 0, wxALIGN_CENTER_HORIZONTAL, 0 );
    
    
    this->SetSizer( masterPanelSizer );
    this->Layout();
    masterPanelSizer->Fit( this );
