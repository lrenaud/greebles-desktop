...
MainMenu::MainMenu()
{
    ...
    ADD_MM_MC(25, 10, 44, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(72, 10, 39, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(116, 10, 38, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(158, 10, 38, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(196, 10, 44, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(240, 10, 39, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(285, 10, 38, 70, MSG_INVALID, MSG_INVALID);
    ADD_MM_MC(330, 10, 32, 70, MSG_INVALID, MSG_INVALID);
