...
#define ADD_MI_MC(x, y, w, h, hover, clicked) menuChoices.push_back(new MenuChoice{ {x, y, w, h}, hover, clicked, CID_MENU_INSTRUCTIONS_2_HOVER, CID_MENU_INSTRUCTIONS_2_PRESSED })
